...
helping_text = 'Список админских команд в боте:\n\n/global - глобальная рассылка (<b>/global <текст рассылки></b>)' \
               '\n\n/downloadarticle - добавление своей статьи в БД ' \
               '(<b>/downloadarticle авторы|темы|название|ссылка</b>)\n\n' \
               '/downloadtheme - добавление темы в БД (<b>/downloadtheme <название темы></b>)'
